    ...
    HodComponent.prototype.setQuarterFeedback = function (data) {
        ...
        if (data.feedback == 'true')
            __WEBPACK_IMPORTED_MODULE_4_alertifyjs__["confirm"]("Do you realy want to Approve this??", function () {
                _this.utServ.approve(data.quarterId, { comment: data.comment }).subscribe(function (reponse) {
                    console.log(reponse);
                }, function (error) {
                    console.log(error);
                });
            ...
            __WEBPACK_IMPORTED_MODULE_4_alertifyjs__["confirm"]("Do you realy want to Reject this??", function () {
                _this.utServ.reject(data.quarterId, { comment: data.comment }).subscribe(function (reponse) {
                    console.log(reponse);
                }, function (error) {
                    console.log(error);
                });
