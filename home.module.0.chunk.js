...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_alertifyjs__ = __webpack_require__("../../../../alertifyjs/build/alertify.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_alertifyjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_alertifyjs__);
...
var HomeComponent = (function (_super) {
    ...
    HomeComponent.prototype.saveQuarterResult = function (quarter) {
        ...
        if (!quarter.isUpdating) {
            ...
            this.utServ.updateQuarterResult(quarter.id, object_1).subscribe(function (response) {
                _this.loaderService.setTransactionLoader(false);
                __WEBPACK_IMPORTED_MODULE_6_alertifyjs__["success"]("Updated");
    ...
    HomeComponent.prototype.saveQuarterResultWithMou = function (lev) {
        ...
        this.utServ.saveQuarterResultWithMou(lev.id, object).subscribe(function (response) {
            ...
            _this.loaderService.setTransactionLoader(false);
            __WEBPACK_IMPORTED_MODULE_6_alertifyjs__["success"]("Saved");
        });
    };
    ...
    HomeComponent.prototype.deleteMou = function (mous, mou, index) {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_6_alertifyjs__["confirm"]("Are you sure you want to delete this mou", function () {
            ...
            _this.utServ.deleteMou(mou.id).subscribe(function (response) {
                mous.splice(index, 1);
                _this.loaderService.setTransactionLoader(false);
                __WEBPACK_IMPORTED_MODULE_6_alertifyjs__["success"]("Sucessfully removed");
            }, function (error) {
                __WEBPACK_IMPORTED_MODULE_6_alertifyjs__["error"]("Something went wrong");
            });
        }).setHeader("Confirmation");
    };
    HomeComponent.prototype.lockQuarterResult = function (quarter) {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_6_alertifyjs__["confirm"]("Are you sure you want to Lock you results", function () {
    ...
    HomeComponent.prototype.collapseOff = function (element) {
        $(element).addClass('in');
